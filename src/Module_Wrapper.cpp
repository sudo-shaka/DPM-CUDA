...
void init_Tissue2D(py::module &m){
  ...
  .def_readwrite("Kc",&cudaDPM::Tissue2D::Kre)
...
void init_Tissue3D(py::module &m){
  py::class_<cudaDPM::Tissue3D>(m, "Tissue3D")
    ...
    .def_readwrite("Kre",&cudaDPM::Tissue3D::Kre)
    .def_readwrite("Kat",&cudaDPM::Tissue3D::Kat)
    ...
    .def("setAttractionMethod",&cudaDPM::Tissue3D::setAttractionMethod)
